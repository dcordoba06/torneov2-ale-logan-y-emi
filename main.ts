...
game.showLongText("¡Oye! Tengo un trabajo para ti, ocupo que limpiez todo el lugar.", DialogLayout.Bottom)
game.showLongText("Y que no se te olvide, ¡tienes que clasificar la basura!", DialogLayout.Bottom)
game.showLongText("Asi son, Basura y pizzas en organico, botellas de plastico en plastico.", DialogLayout.Bottom)
game.showLongText("Y el papel en papel, y cada uno tiene su color, organico: Negro, papel: Azul,", DialogLayout.Bottom)
game.showLongText("y plastico: Gris. Los colores pueden variar, ¡Pero, casi siempre son los mismos!", DialogLayout.Bottom)
info.setScore(0)
txtPizzas = textsprite.create(": 0", 0, 15)
txtPizzas.setPosition(27, 8)
